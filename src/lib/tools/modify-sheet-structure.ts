...
export const modifySheetStructureTool = defineTool({
  ...
  description:
    "Insert, delete, hide, or freeze rows and columns. " +
    "Use reference like '5' for row 5 or 'C' for column C.",
  parameters: Type.Object({
    ...
    reference: Type.Optional(
      Type.String({ description: "Row number or column letter, e.g. '5' or 'C'" })
    ),
    count: Type.Optional(
